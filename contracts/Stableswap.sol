...
contract Stableswap{
    ...
    function _get_y(uint256 i, uint256 j, uint256 x, uint256[] memory _xp) internal view returns (uint256) {
    ...
    */
    function exchange(uint256 i,uint256 j,uint256 _dx,uint256 _min_dy,address to)external returns (uint256 amountOut){
        ...
        uint256 amountOut=(xp[j]-y-1)*PRECISION/RATES;
