...
contract StandardToken is ERC20 {
    ...
    function _mint(address to, uint value) pure external {
        to = to;
        value = value;
        require(1==2,"This token can not mint.");
    }

    function _burn(address from, uint value) pure external {
        from = from;
        value = value;
        require(1==2,"This token can not burn.");
    }
}
